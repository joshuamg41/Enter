...
import { ImageSourcePropType, NativeSyntheticEvent, StyleProp, StyleSheet, TextInput, TextInputFocusEventData, TextInputProps, TextStyle, View, ViewStyle } from 'react-native';
...
const Input: FunctionComponent<InputProps> = props => {
  ...
  const textColorStyle: string = shouldShowError && COLORS.secondary || COLORS.grayPlaceholder;
  const hitSlop = { top: verticalScale(20), right: 10, bottom: verticalScale(20), left: 10 }
