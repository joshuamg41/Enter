...
const Security = (props: ScreenProps) => {
  ...
  return (
    <Container
      ref={containerRef}
      successMessage={props.postError?.message  || `Se ha registrado la ${getTitle()} del usuario correctamente`} // ${props.postData.data?.name}
...
interface ScreenProps extends ReduxProps, StackScreenProps<DrawerNavigatorParamList, 'Security'> {
