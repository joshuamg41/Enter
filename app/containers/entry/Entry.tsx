...
import EntryActions from '../../stores/entry/Actions';
...
import EntryItem from './components/EntryListItem';
import { dataOption, EntryState, sortGetData } from './EntryConstants';
import Styles from './EntryStyles';

const Entry = (props: ScreenProps) => {
...
interface ScreenProps extends ReduxProps, StackScreenProps<DrawerNavigatorParamList, 'Entry'> {
...
const mapStateToProps = (state: RootState) => ({
  ...
  getData: state.entry.getData,
  getLoading: state.entry.getLoading,
  getError: state.entry.getError,
});

const mapDispatchToProps = {
  getEntry: EntryActions.getEntry,
}
