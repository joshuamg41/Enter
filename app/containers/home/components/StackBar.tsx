...
import { horizontalScale, moderateScale, verticalScale, viewportWidth } from '../../../utils/StyleHelpers';
  ...
  return (
    <View style={[Styles.container]}>
      ...
      <View style={Styles.arrowSection}>
        <CheckRender
          allowed={props.index != 0}
          notAllowedReturn={<View />}
        >
          <TouchableOpacity
            onPress={() => props.scrollViewRef?.scrollTo({ x: -viewportWidth, y: 0 })}
          >
            <Ionicons
              style={Styles.arrow}
